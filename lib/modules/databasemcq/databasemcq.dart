...
import 'package:task_section_3/modules/homepage/homepage.dart';

class Databasemcq extends StatefulWidget {
  @override
  State<Databasemcq> createState() => _DatabasemcqState();
}

class _DatabasemcqState extends State<Databasemcq> {
  late int point;
   int? Q1s=5;
   int? Q2s=5;
